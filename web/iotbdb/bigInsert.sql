...
((SELECT ORDERID FROM ORDERTABLE WHERE ORDERTOTAL=200.00), 1),
((SELECT ORDERID FROM ORDERTABLE WHERE ORDERTOTAL=190.00), 2),
((SELECT ORDERID FROM ORDERTABLE WHERE ORDERTOTAL=180.00), 1);
...
((SELECT PAYMENTID FROM PAYMENTTABLE WHERE PAYMENTTYPE=2), '7654321', '2023-06-12', 'Ashley Hunter', '321');
